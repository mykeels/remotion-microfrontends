...
export const loadScript = (id: string, src: string): Promise<HTMLScriptElement> => {
...
export const loadMicrofrontend = async ({ entry, scope, module }: { entry: string, scope: string, module: string }) =>
